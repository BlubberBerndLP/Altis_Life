...
/*  Example
    player createDiaryRecord ["", //Container
        [
            "", //Subsection
                "
Welcome! Have Fun and read the Rules :)<br/><br/>
                "
        ]
    ];
*/
    ...
    player createDiaryRecord ["credits",
        [
            "ArmaLife",
                "
Altis Life RPG von Tonic<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord["changelog",
        [
            "Altis Life Changelog",
                "
The official changelog can be found in Altis_Life.Altis github. https://github.com/BlubberBerndLP/Altis_Life.Altis<br/><br/>
                "
        ]
    ];
