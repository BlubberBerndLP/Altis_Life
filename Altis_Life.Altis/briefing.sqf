...
*/
	player createDiaryRecord["changelog",
		[
			"Official Change Log",
				"
					Alle Änderungen stehen im Forum: meinaltis.de
				"
		]
	];
	...
	player createDiaryRecord["changelog",
		...
		[
			"Exploits", 
				"
				Alle Regeln findest du in unserem Forum ! www.meinaltis.de!<br/>
				"
		]
	];
...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				"
				Alle Regeln findest du in unserem Forum ! meinaltis.de!<br/>licopters cannot hover over the city. Cops may only hover over the city if there is an active police operation going on.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Regeln",
				...
				2. Alles weitere unter meinaltis.de zu finden<br/><br/>
				"
		]
	];
